...
if(isset($_POST['submit'])){
   ...
   $imageKpB_folder = 'uploaded_kpb/'.$rename_imgKpB;
     ...
     $insert_addList = $conn->prepare("INSERT INTO `orders_list` (unique_id, email, nama, phoneno, phonenoTambahan, nokp, alamatPemasangan, alamatBill, pid, tarikhWaktu, imgBill, imgKpD, imgKpB, referCode) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
     $insert_addList->execute([$unique_id, $email, $nama, $phoneno, $phonenoTambahan, $nokp, $alamatPemasangan, $alamatBill, $pid, $tarikhWaktu, $rename_imgBill, $rename_imgKpD, $rename_imgKpB, $referCode]);
     $success_msg[] = 'your submit form successfull!';
   ...
   <form action="" method="POST" enctype="multipart/form-data">
    ...
    <button class="btn" id="clear-c">
      ...
      <div class="box">
         ...
         $select_user->execute([$unique_id]);
            if($select_user->rowCount() > 0){
               while($fetch_user_now = $select_user->fetch(PDO::FETCH_ASSOC)){
         ?>
         <input type="hidden" name="referCode" class="input" value="<?= $fetch_user_now['refer_code'];?>">
         <?php 
               }
            }
         ?>
      ...
      <div class="box">
         ...
         <input type="email" name="email"  placeholder="Isi Email" class="input">
      </div>
      <div class="box">
         <p>2. Nama Penuh <span class="wrong">*</span></p>
         <input type="text" name="nama"  placeholder="Isi Nama Penuh" class="input" required>
         </div>
      <div class="box">
      ...
      <div class="box">
         ...
         <input type="number" name="nokp" maxlength="12"  placeholder="Contoh: 93110408****" class="input">
         </div>
      <div class="box">
         <p>6. Alamat Penuh Pemasangan <span class="wrong">*</span></p>
         <textarea name="alamatPemasangan" class="input"  cols="30" rows="5" placeholder="Isi Alamat Pemasangan"></textarea>
      </div>
      <div class="box">
         <p>7. Alamat S/Menyurat <span class="wrong">*</span></p>
         <textarea name="alamatBill" class="input"  cols="30" rows="5" placeholder="Isi Alamat Pemasangan"></textarea>
      </div>
    ...
    <p>8. Pakej Unifi Terkini 2024</p>
      ...
      ?>
        ...
        <div class="box">
         ...
         <input type="text" name="tarikhWaktu" id="timedatePicker" autocomplete="off" placeholder="Pilih Tarikh & Waktu" class="input">
         </div>
