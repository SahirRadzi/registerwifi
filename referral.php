...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <label> Your Referral Click :</label>
        <input type="email" name="email" maxlength="50" placeholder="<?=$fetch_referral['click'];?>" class="box" readonly>
      <label> Your Referral Url :</label>
        <input type="text" name="number" min="0" max="9999999999" maxlength="11" id="myInput" value="https://app.registerwifi.online/register?ref=<?= $fetch_referral['referral_code'];?>" class="box">
  ...
  <form action="">
    ...
    <tbody>
      ...
      if($select_personRefer->rowCount() > 0){
          while($referral_list = $select_personRefer->fetch(PDO::FETCH_ASSOC)){
